...
var buttonOpen = document.querySelector(".btn-open-close");
...
buttonOpen.addEventListener("click", function () {
  var menuTransform1 = getComputedStyle(btnBarre1).transform;
  var menuTransform2 = getComputedStyle(btnBarre2).transform;
  var rotation1 = getRotationAngle(menuTransform1);
  var rotation2 = getRotationAngle(menuTransform2);
