import "./cat-comment-booster-mon-business-avec-le-digital.scss";
...
const textContainer21 = document.querySelector(".text-container-21");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = textContainer21.getBoundingClientRect().top;
...
const textContainer22 = document.querySelector(".text-container-22");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = textContainer22.getBoundingClientRect().top;
...
const textContainer23 = document.querySelector(".text-container-23");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = textContainer23.getBoundingClientRect().top;
...
const textContainer24 = document.querySelector(".text-container-24");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = textContainer24.getBoundingClientRect().top;
...
const textContainer25 = document.querySelector(".text-container-25");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = textContainer25.getBoundingClientRect().top;
...
const textContainer26 = document.querySelector(".text-container-26");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = textContainer26.getBoundingClientRect().top;
...
const textContainer27 = document.querySelector(".text-container-27");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = textContainer27.getBoundingClientRect().top;
...
const textContainer28 = document.querySelector(".text-container-28");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = textContainer28.getBoundingClientRect().top;
...
const textContainer29 = document.querySelector(".text-container-29");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = textContainer29.getBoundingClientRect().top;
...
const textContainer30 = document.querySelector(".text-container-30");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = textContainer30.getBoundingClientRect().top;
...
const textContainer31 = document.querySelector(".text-container-31");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = textContainer31.getBoundingClientRect().top;
...
const text22 = document.querySelector(".text-22");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = text22.getBoundingClientRect().top;
...
const text23 = document.querySelector(".text-23");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = text23.getBoundingClientRect().top;
...
const text24 = document.querySelector(".text-24");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = text24.getBoundingClientRect().top;
...
const text25 = document.querySelector(".text-25");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = text25.getBoundingClientRect().top;
...
const text26 = document.querySelector(".text-26");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = text26.getBoundingClientRect().top;
...
const text27 = document.querySelector(".text-27");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = text27.getBoundingClientRect().top;
...
const text28 = document.querySelector(".text-28");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = text28.getBoundingClientRect().top;
...
const text29 = document.querySelector(".text-29");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = text29.getBoundingClientRect().top;
...
const text30 = document.querySelector(".text-30");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = text30.getBoundingClientRect().top;
...
const text31 = document.querySelector(".text-31");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = text31.getBoundingClientRect().top;
...
const text32 = document.querySelector(".text-32");

window.addEventListener("scroll", () => {
  const { scrollTop, clientHeight } = document.documentElement;

  const topElementToTopViewport = text32.getBoundingClientRect().top;
